...
import { ExternalLink, AlertTriangle, CheckSquare, BarChart2, Clock, Activity, MessageSquare } from "lucide-react";

export default function ReviewRecency() {
  return (
    <Layout>
      <div className="min-h-screen bg-[#0f1115] text-foreground font-sans selection:bg-primary selection:text-white grid-pattern p-8">
        ...
        <div className="flex gap-2 mb-6">
          ...
          <Badge variant="outline" className="border-[#ff4400] text-[#ff4400] font-mono text-[10px] uppercase rounded-sm px-2 py-1">ALGORITHM</Badge>
          <Badge variant="outline" className="border-[#ff4400] text-[#ff4400] font-mono text-[10px] uppercase rounded-sm px-2 py-1">TRUST SIGNALS</Badge>
        </div>
        ...
        <p className="text-slate-400 font-mono text-sm max-w-3xl mb-12">
          Maintaining a consistent stream of reviews to signal relevance to Google's algorithm.
        </p>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section>
              ...
              <div className="space-y-6 font-mono text-sm text-slate-300 leading-relaxed">
                <p>
                  It's not just about the <span className="text-white font-bold">*number*</span> of reviews. It's about <span className="text-white font-bold">Velocity</span> (how often) and <span className="text-white font-bold">Recency</span> (how new).
                </p>
                <p>
                  <span className="text-white font-bold">The Algorithm:</span> A business with 50 reviews (last one yesterday) will often outrank a business with 200 reviews (last one 6 months ago).
                </p>
                <p>
                  <span className="text-white font-bold">The 'Drip' Method:</span> Don't blast your entire email list at once. You want a steady trickle of reviews, not a flood followed by a drought.
                </p>
              </div>
            </section>
              ...
              <div className="space-y-8">
                <div className="group">
                  <div className="text-[#ff4400] font-mono text-xs font-bold mb-2 flex items-center gap-2">
                    <span className="bg-[#ff4400]/10 px-1 rounded">01</span> Consistent Request Cadence
                  </div>
                  <div className="bg-[#14171c] border border-slate-800 p-4 rounded-sm">
                    <p className="font-mono text-sm text-slate-300">
                      Automate requests to go out daily based on completed jobs. Do not batch them weekly or monthly.
                    </p>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="text-[#ff4400] font-mono text-xs font-bold mb-2 flex items-center gap-2">
                    <span className="bg-[#ff4400]/10 px-1 rounded">02</span> Response Velocity
                  </div>
                  <div className="bg-[#14171c] border border-slate-800 p-4 rounded-sm">
                    <p className="font-mono text-sm text-slate-300">
                      Reply to every review within 24 hours. This counts as 'activity' on your profile. Use keywords in your reply: 'Glad we could fix your AC in Bethesda!'.
                    </p>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="text-[#ff4400] font-mono text-xs font-bold mb-2 flex items-center gap-2">
                    <span className="bg-[#ff4400]/10 px-1 rounded">03</span> Review Revival
                  </div>
                  <div className="bg-[#14171c] border border-slate-800 p-4 rounded-sm">
                    <p className="font-mono text-sm text-slate-300">
                      Identify long-time customers who haven't reviewed. Send a personal 'We appreciate your loyalty' email asking for a review.
                    </p>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="text-[#ff4400] font-mono text-xs font-bold mb-2 flex items-center gap-2">
                    <span className="bg-[#ff4400]/10 px-1 rounded">04</span> Negative Review Protocol
                  </div>
                  <div className="bg-[#14171c] border border-slate-800 p-4 rounded-sm">
                    <p className="font-mono text-sm text-slate-300">
                      Respond professionally, take it offline immediately. 'Please call the owner directly at [Number]'. Never argue publicly.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                {[
                  { name: "GatherUp", url: "#" },
                  { name: "Reputation.com", url: "#" },
                  { name: "Google Business Profile App", url: "#" }
                ].map((tool, i) => (
                  <li key={i}>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                {[
                  { name: "Review Velocity Impact", url: "#" },
                  { name: "Responding to Reviews", url: "#" }
                ].map((source, i) => (
                  <li key={i}>
