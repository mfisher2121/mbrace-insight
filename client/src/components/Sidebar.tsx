...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { name: "LEAD AUTOMATION", icon: Bot, href: "/automation" },
    { name: "VAPI AGENT", icon: Mic2, href: "/vapi" },
    { name: "FOLLOW-UP AUTOMATION", icon: MessageSquare, href: "/follow-up" },
    { name: "HYPER-LOCAL SEO", icon: MapPin, href: "/seo" },
    { name: "GMP OPTIMIZATION", icon: Globe, href: "/gmp" },
    { name: "REVIEW SYSTEMS", icon: Star, href: "/reviews" },
    { name: "REVIEW STRATEGY", icon: MessageCircle, href: "/review-strategy" },
    { name: "LEAD SOURCES", icon: Phone, href: "/sources" },
    { name: "MARKET INTEL", icon: PieChart, href: "/intel" },
